...
namespace BaseProj.Converters
{
    ...
    public class IntToEnumConverter : MarkupExtension, IValueConverter
    {
        private static IntToEnumConverter _converter;
        ...
        {
            return _converter ?? (_converter = new IntToEnumConverter());
        }
    }
}