...
namespace BaseProj.SharpVectors.SharpVectorDom
{
    ...
    public class Document : XmlDocument, IDocument, INode, IEventTargetSupport, IDocumentEvent
    {
        ...
        /// </summary>
        public bool MutationEvents { get; set; } = false;
        ...
        {
            if (MutationEvents) throw new NotImplementedException();
        }
        ...
        private void WhenNodeInserted(
            ...
            XmlNodeChangedEventArgs e)
        {
            var newParent = e.NewParent as INode;
            var node = e.Node as INode;

            if (newParent != null && node != null) InsertedNode(newParent, node, false);
        }
            ...
            XmlNodeChangedEventArgs e)
        {
            ...
            if (node != null) InsertingNode(node, false);
        }
            ...
            XmlNodeChangedEventArgs e)
        {
            ...
            if (node != null) RemovedNode(node, false);
        }
        ...
        private void WhenNodeRemoving(
            ...
            XmlNodeChangedEventArgs e)
        {
            var oldParent = e.OldParent as INode;
            var node = e.NewParent as INode;

            if (oldParent != null && node != null) RemovingNode(oldParent, node, false);
        }
        ...
        IDocumentType IDocument.Doctype => (IDocumentType)DocumentType;

        IDomImplementation IDocument.Implementation => throw new DomException(DomExceptionType.NotSupportedErr);

        IElement IDocument.DocumentElement => (IElement)DocumentElement;
