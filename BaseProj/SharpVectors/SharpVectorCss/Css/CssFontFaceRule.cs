...
{
    /// <summary>
    ///     The CSSFontFaceRule interface represents a @font-face rule in a CSS style sheet. The @font-face rule is used to
    ...
    public class CssFontFaceRule : CssRule, ICssFontFaceRule
    {
        ...
        /// </summary>
        public override CssRuleType Type => CssRuleType.FontFaceRule;

        #endregion

        #region Static members

        private static readonly Regex regex = new Regex(@"^@font-face");
            ...
            IList<string> replacedStrings, CssStyleSheetType origin)
        {
            ...
            if (match.Success)
            {
                var rule = new CssFontFaceRule(match, parent, readOnly,
        ...
        /// </summary>
        public ICssStyleDeclaration Style => style;
