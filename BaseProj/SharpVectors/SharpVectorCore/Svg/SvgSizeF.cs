...
namespace BaseProj.SharpVectors.SharpVectorCore.Svg
{
    ...
    public struct SvgSizeF : IEquatable<SvgSizeF>
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SvgSizeF" /> class from the specified existing
        ///     <see cref="SvgSizeF" />.
        /// </summary>
        ...
        {
            if (sz1.Width == sz2.Width) return sz1.Height == sz2.Height;
        ...
        public bool IsEmpty
        {
            get
            {
                if (_width == 0.0) return _height == 0.0;
        ...
        {
            if (obj is SvgSizeF) return Equals((SvgSizeF)obj);
        ...
        /// <returns>
        ///     This returns <see langword="true" /> if the specified <see cref="SvgSizeF" /> and has the same width and height as
        ///     this <see cref="SvgSizeF" />;
        ///     otherwise, <see langword="false" />.
        /// </returns>
