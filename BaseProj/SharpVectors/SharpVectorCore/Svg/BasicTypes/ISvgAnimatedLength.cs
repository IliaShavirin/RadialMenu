...
namespace BaseProj.SharpVectors.SharpVectorCore.Svg.BasicTypes
{
    ...
    public interface ISvgAnimatedLength
    {
        ...
        ///     contains the current animated value of the attribute or property, and both the object itself and its contents are
        ///     readonly. If the given attribute or property is not currently being animated, contains the same value as 'baseVal'.
        /// </summary>
