...
namespace BaseProj.SharpVectors.SharpVectorCore.Utils.Xml
{
    ...
    public sealed class DynamicXmlUrlResolver : XmlUrlResolver
    {
        ...
        public override object GetEntity(Uri absoluteUri, string role, Type ofObjectToReturn)
        {
            ...
            {
                var entity = GettingEntity(absoluteUri, role, ofObjectToReturn);
                if (entity != null)
                    return entity;
            }
        ...
        ///     The URI to resolve. The URI can be absolute or relative. If absolute, this value effectively
        ///     replaces the <paramref name="baseUri" /> value. If relative, it combines with the <paramref name="baseUri" /> to
        ...
        ///     <paramref name="baseUri " />is null or <paramref name="relativeUri" /> is null
        /// </exception>
