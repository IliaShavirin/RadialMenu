namespace BaseProj.SharpVectors.SharpVectorCore.Css
{
    ...
    public interface ICssValueList : ICssValue
    {
        ...
        /// <summary>
        ///     Used to retrieve a CSSValue by ordinal index. The order in this collection represents the order of the values in
        ///     the CSS style property. If index is greater than or equal to the number of values in the list, this returns null.
        /// </summary>
