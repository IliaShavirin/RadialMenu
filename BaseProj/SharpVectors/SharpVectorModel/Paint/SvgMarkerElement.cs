...
namespace BaseProj.SharpVectors.SharpVectorModel.Paint
{
    public sealed class SvgMarkerElement : SvgStyleableElement, ISvgMarkerElement
    {
        ...
        public ISvgAnimatedLength RefX
        {
            get
            {
                if (refX == null) refX = new SvgAnimatedLength(this, "refX", SvgLengthDirection.Horizontal, "0");
                return refX;
            }
        }
        ...
        public ISvgAnimatedLength RefY
        {
            get
            {
                if (refY == null) refY = new SvgAnimatedLength(this, "refY", SvgLengthDirection.Vertical, "0");
                return refY;
            }
        }
        ...
        public ISvgAnimatedEnumeration MarkerUnits
        {
            get
            {
                if (markerUnits == null)
                {
                    var type = SvgMarkerUnit.Unknown;
        ...
        /// <summary>
        ///     Corresponds to attribute orient on the given 'marker' element. If markerUnits is SVG_MARKER_ORIENT_ANGLE, the angle
        ///     value for attribute orient; otherwise, it will be set to zero.
        /// </summary>
        public ISvgAnimatedAngle OrientAngle
        {
            get
