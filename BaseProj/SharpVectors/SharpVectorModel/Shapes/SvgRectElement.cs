...
namespace BaseProj.SharpVectors.SharpVectorModel.Shapes
{
    ...
    public sealed class SvgRectElement : SvgTransformableElement, ISvgRectElement
    {
        ...
        public ISvgAnimatedLength Width
        {
            get
            {
                if (width == null) width = new SvgAnimatedLength(this, "width", SvgLengthDirection.Horizontal, "100");
                return width;
            }
        }
        ...
        public ISvgAnimatedLength Height
        {
            get
            {
                if (height == null) height = new SvgAnimatedLength(this, "height", SvgLengthDirection.Vertical, "100");
                return height;
            }
        }
        ...
        public ISvgAnimatedLength Rx
        {
            get
            {
                if (rx == null) rx = new SvgAnimatedLength(this, "rx", SvgLengthDirection.Horizontal, "0");
                return rx;
            }
        }
        ...
        public ISvgAnimatedLength Ry
        {
            get
            {
                if (ry == null) ry = new SvgAnimatedLength(this, "ry", SvgLengthDirection.Vertical, "0");
                return ry;
            }
        }
