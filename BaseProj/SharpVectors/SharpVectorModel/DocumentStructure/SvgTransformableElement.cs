...
namespace BaseProj.SharpVectors.SharpVectorModel.DocumentStructure
{
    public class SvgTransformableElement : SvgStyleableElement, ISvgTransformable
    {
        ...
        public ISvgAnimatedTransformList Transform
        {
            get
            {
                if (transform == null) transform = new SvgAnimatedTransformList(GetAttribute("transform"));
                return transform;
            }
        }
        ...
        public ISvgElement NearestViewportElement
        {
            get
            {
                ...
                while (parent != null)
                {
                    if (parent is SvgSvgElement) return (ISvgElement)parent;
        ...
        {
            var svgWnd = OwnerDocument.Window;
            if (svgWnd == null || svgWnd.Renderer == null) return null;
        ...
        public ISvgMatrix GetCTM()
        {
            ...
            {
                svgTList = Transform.AnimVal;
                matrix = svgTList.Consolidate().Matrix;
            }

            var nVE = NearestViewportElement;
            if (nVE != null)
            {
                var par = ParentNode as SvgTransformableElement;
        ...
        {
            var loc = element as ISvgLocatable;
            var ctm = loc.GetCTM();
            ISvgMatrix vctm;
