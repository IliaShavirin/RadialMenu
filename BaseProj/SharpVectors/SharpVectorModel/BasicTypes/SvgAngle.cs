...
namespace BaseProj.SharpVectors.SharpVectorModel.BasicTypes
{
    ...
    public sealed class SvgAngle : ISvgAngle
    {
        ...
        ///     attributes unitType, valueAsSpecified and valueAsString might be modified as a result of this method.
        /// </summary>
        ...
        {
            var newValue = cssAngle.GetFloatValue((CssPrimitiveType)unitType);
        ...
        /// </summary>
        public SvgAngleType UnitType => (SvgAngleType)cssAngle.PrimitiveType;

        /// <summary>
        ///     The angle value as a floating point value, in degrees. Setting this attribute will cause valueInSpecifiedUnits and
        ...
        public double Value
        {
            get => cssAngle.GetFloatValue(CssPrimitiveType.Deg);
            set
            {
                if (readOnly)
                    throw new DomException(DomExceptionType.NoModificationAllowedErr,
                        "Cannot set readonly angle value");

                var oldType = cssAngle.PrimitiveType;
        ...
        /// <summary>
        ///     The angle value as a floating point value, in the units expressed by unitType. Setting this attribute will cause
        ...
        {
            get => cssAngle.GetFloatValue(cssAngle.PrimitiveType);
            set
            {
                if (readOnly)
                    throw new DomException(DomExceptionType.NoModificationAllowedErr,
        ...
        /// <summary>
        ///     The angle value as a string value, in the units expressed by unitType. Setting this attribute will cause value and
