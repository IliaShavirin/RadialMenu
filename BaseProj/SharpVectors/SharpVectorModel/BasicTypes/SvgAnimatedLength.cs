...
namespace BaseProj.SharpVectors.SharpVectorModel.BasicTypes
{
    ...
    public sealed class SvgAnimatedLength : ISvgAnimatedLength
    {
        ...
        private readonly SvgLength baseVal;
        ...
        /// </summary>
        public ISvgLength BaseVal => baseVal;

        /// <summary>
        ///     If the given attribute or property is being animated, contains the current animated value of the attribute or
        ///     property, and both the object itself and its contents are readonly. If the given attribute or property is not
        ///     currently being animated, contains the same value as 'baseVal'.
        /// </summary>
        public ISvgLength AnimVal => baseVal;
